...
Original file is located at
    https://colab.research.google.com/drive/1sjP9UGpfop9-d5Xj9YOSH7Ua2NZGyBgz
"""
...
def format_prop(prop):
  # PART 1 : PART A
    ...
    if 2 == len(prop):
        ...
        if "not" == op:
            formatted_prop = "(not %s)" % (format_prop(prop1))
...
def eval_prop(prop, values):
    ...
    # UNARY OPERATOR (not): ##########################
        ...
        prop1= prop[1] 
        if "not" == op:
          # good = eval_prop(prop1,values)
          # return int(not good)
          return int(not eval_prop(prop1, values))
...
##################################################
    ...
    # PART 6 : PART B
        ...
        # elif "iff" == op:
        #     return int( (left or not right) and (not left or right))
        elif "iff" == op:
